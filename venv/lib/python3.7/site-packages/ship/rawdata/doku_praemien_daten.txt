...
# The original documentation for the csv files of the BAG.
# Not all that accurate unfortunately.
...
Praemien_CH_2012-11923-v22_pub.csv: Angebotene Prämien in der Schweiz
Praemien_EU_2012-11913-v1.csv:      Angebotene Prämien in der EU

Musterdatensatz:
    #01  G_ID      :  0008  : BAG-Nummer
    #02  C_ID      :  "AG"  : Kanton (oder Land)
    #03  C_GRP     :  "CH"  : "CH" oder "EU"
    #04  EJAHR     :  2011  : Jahr, in welchem die Prämien erhoben wurden
    #05  JAHR      :  2012  : Jahr, für welches die Prämien gelten
    ...
    #14  isBASE_P  :  0     : "1": ist Grundprämie (OKP mit Unfall)
    #15  isBASE_F  :  0     : "1": ist Grundfranchise ( 300 bzw. 0 Franken)
    #16  F_STUFE   :  2     : Franchisestufe ("1": Grundfranchise)
    #17  F         :  100   : Franchise
    #18  P         :  55.4  : Prämie in Franken und Rappen

Nur CH-Daten :
    #19  V_SORT_NR :  1     : Sortierordnung für Versicherungsmodelle
    ...
    #22  IstTaetig :  1.0   : "1.0": tätig; "1.1": eingeschränkt tätig
